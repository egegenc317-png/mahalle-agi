      ...
      <Card className="border-amber-200 bg-white/95 shadow-sm">
        ...
        <CardContent>
          <p className="mb-2 text-xs text-zinc-600">
            Sadece admin veya bu haftanın mahalle muhtarı anket açabilir. Muhtar, o hafta sitede en çok süre geçiren kullanıcıdan seçilir ve yeni hesaplar da yarışmaya dahildir.
          </p>
